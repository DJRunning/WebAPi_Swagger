                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "SwaggerTest接口在线文档");
                        ...
                        //启用注释文档
                        c.IncludeXmlComments(string.Format("{0}/bin/SwaggerTest.XML", System.AppDomain.CurrentDomain.BaseDirectory));
